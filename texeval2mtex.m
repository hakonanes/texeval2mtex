...
path = ['/path/to/res/file/directory/'];
fnamesPrefix = 'filename_prefix';
...
cube = orientation('Miller',[1 0 0],[0 0 1],cs,ssO);
cubeND22 = orientation('Euler',22*degree,0,0,cs,ssO);
cubeND45 = orientation('Miller',[1 0 0],[0 1 1],cs,ssO);
goss = orientation('Miller',[1 1 0],[0 0 1],cs,ssO);
p = orientation('Miller',[0 1 1],[1 2 2],cs,ssO);
q = orientation('Miller',[0 1 3],[2 3 1],cs,ssO);
